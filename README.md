...
* Modyfikować kod na własne potrzeby (np. zmieniać interfejs, dodawać stacje, itp.).
* Udostępniać swoje poprawki innym, o ile zachowasz informację o oryginalnym autorze i tę samą licencję.
* Uczyć się na tym kodzie i wykorzystywać jego fragmenty w innych darmowych projektach.

### ❌ Czego NIE MOŻESZ robić:
* **Sprzedawać tego kodu** ani żadnej jego części.
* Sprzedawać urządzeń (odbiorników radiowych) z wgranym tym oprogramowaniem bez mojej wyraźnej zgody.
